...
If Welcome.java doesn't exist program
exits.

Now Temp.java if already exists program
exits and if it doesn't program copies
contents of Welcome.java in Temp.java.
*****************************************/
