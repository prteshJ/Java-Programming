...
public class BeanMachinePane  extends Pane {
    ...
    private void paintBeanMachine() {
        ...
        // Draw triangle circles // ( 7+6+5+4+3+2+1 = 28 ) circles
        ...
        // Connect the base of the triangle with lowerLine (7 lines for 7 circles)
        ...
        // Draw extreme right  and left  bottom line
        ...
        // Draw long left & right side line
        for (int i = 2; i < 4; i++) {
