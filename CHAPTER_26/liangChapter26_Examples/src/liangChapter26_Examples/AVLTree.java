...
public class AVLTree<E extends Comparable<E>> extends BST<E> {
	...
	private void updateHeight(AVLTreeNode<E> node) {
		...
		else if(node.right == null) // node has no left subtree
	...
	public boolean delete(E element) {
		...
		if(current.left == null) {
			...
			if(parentOfRightMost.right == rightMost)
				 ...
				 * current.left points to the 
				 * large element in the left subtree of current. 
				 * In this case, rightMost is current. left and 
				 * parentOfRightMost is current. 
				 * You have to take care of this special case to 
				 * reconnect the right child of rightMost with 
				 * parentOfRightMost.
				 */
